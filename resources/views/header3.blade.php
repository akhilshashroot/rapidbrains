<header class="wrapper">
        ...
        <nav class="navbar navbar-expand-lg center-nav transparent position-absolute navbar-dark px-md-10 px-xxl-0">
          <div class="container flex-lg-row flex-nowrap align-items-center">
            ...
            <img  class="logo-dark img-logo" src="{{asset('assets/img/RapidBrains-logo.svg')}}" srcset="{{asset('assets/img/RapidBrains-logo')}}@2x.svg 2x" alt="RapidBrains Logo"  class="img-logo"/>

            <img class="logo-light img-logo" src="{{asset('assets/img/RapidBrains-white@2x.svg')}}" srcset="{{asset('assets/img/RapidBrains-white')}}@2x.svg 2x" alt="RapidBrains Logo"  class="img-logo"/>
