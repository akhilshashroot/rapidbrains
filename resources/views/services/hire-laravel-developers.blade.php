           ...
           <div class="row position-relative">
             <div class="col-lg-8 col-xxl-7 mx-auto position-relative">
               ...
               <div data-cues="slideInDown" data-group="page-title">
                 <h1 class="display-1 fs-62 mb-5 mx-md-10 mx-lg-0">Hire Remote Laravel Developers in 24 Hours!.</h1>
                 <p class="lead fs-18 mb-8">Accelerate your projects with skilled remote Laravel developers.</p>
                 <a href="https://talents.rapidbrains.com/filter?skill=laravel" class="btn btn-lg btn-primary btn-icon btn-icon-end mx-auto" style="color: #fff; max-width: 100%;">List all Laravel Developers with rates <i class="uil uil-arrow-up-right"></i></a>
  ...
  <div class="container py-14 py-md-16">
    <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
      <div class="col-lg-5 order-lg-2">
        <figure><img class="w-auto" style="width: 500px; height: 500px; max-width: 80%;" src="https://www.rapidbrains.com/assets/img/services/rapidbrains-laravel.webp" srcset="https://www.rapidbrains.com/assets/img/services/rapidbrains-laravel.webp" alt="Laravel Logo" /></figure>
      </div>
      <!--/column -->
      <div class="col-lg-7">
  ...
  <div class="container py-14 py-md-16">
    <div class="row d-flex align-items-start gy-10">
      <div class="col-lg-5 position-lg-sticky" style="top: 8rem;">
        ...
        <!--<a href="https://talents.rapidbrains.com/filter?skill=ASP.NET" class="btn btn-lg btn-primary btn-icon btn-icon-end mx-auto" style="color: #fff; max-width: 100%;">Hire Now <i class="uil uil-arrow-up-right"></i></a>-->
      </div>
      <!-- /column -->
