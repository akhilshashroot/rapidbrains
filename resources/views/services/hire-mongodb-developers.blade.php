           ...
           <div class="row position-relative">
             <div class="col-lg-8 col-xxl-7 mx-auto position-relative">
               ...
               <div data-cues="slideInDown" data-group="page-title">
                 <h1 class="display-1 fs-62 mb-5 mx-md-10 mx-lg-0">Hire Remote MongoDB Developers in 24 Hours!</h1>
                 ...
                 <a href="https://talents.rapidbrains.com/filter?skill=MongoDB" class="btn btn-lg btn-primary btn-icon btn-icon-end" style="color: #fff;">Hire Developers <i class="uil uil-arrow-up-right"></i></a>
  ...
  <div class="container py-14 py-md-16">
    <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
      <div class="col-lg-5 order-lg-2">
        <figure><img class="w-auto" style="width: 500px; height: 500px; max-width: 80%;" src="https://www.rapidbrains.com/assets/img/services/rapidbrains-mongodb.webp" srcset="https://www.rapidbrains.com/assets/img/services/rapidbrains-mongodb.webp" alt="MongoDB Logo" /></figure>
      </div>
      <!--/column -->
      <div class="col-lg-7">
...
<section class="wrapper bg-soft-red">
  <div class="container py-14 py-md-16">
    ...
    <div class="row">
      ...
      <a href="https://talents.rapidbrains.com/filter?skill=MongoDB" class="btn btn-lg btn-primary btn-icon btn-icon-end" style="color: #fff;">Hire MongoDB Developers <i class="uil uil-arrow-up-right"></i></a>
      </div>
      <!-- /column -->
    </div>
    <!-- /.row -->
