           ...
           <div class="row position-relative">
             <div class="col-lg-8 col-xxl-7 mx-auto position-relative">
               ...
               <div data-cues="slideInDown" data-group="page-title">
                 ...
                 <a href="https://talents.rapidbrains.com/filter?skill=BigCommerce" class="btn btn-lg btn-primary btn-icon btn-icon-end mx-auto" style="color: #fff; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; max-width: 100%; display: inline-block;">List all BigCommerce Developers with rates <i class="uil uil-arrow-up-right"></i></a>
