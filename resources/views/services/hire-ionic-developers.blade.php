    ...
    <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
      <div class="col-lg-6 position-relative order-lg-2">
        ...
        <div class="overlap-grid overlap-grid-2">
          <div class="item">
            <figure class="rounded shadow"><img src="{{asset('assets/img/services/Ionic-image.jpg')}}" srcset="{{asset('assets/img/services/Ionic-image.jpg')}} 2x" alt=""></figure>
          </div>
          <div class="item">
            <figure class="rounded shadow"><img src="{{asset('assets/img/services/Ionic.png')}}" srcset="{{asset('assets/img/services/Ionic.png')}}" alt=""></figure>
          </div>
        </div>
      </div>
      <!--/column -->
...
<section class="wrapper bg-soft-yellow" style="padding-top: 50px;">
  <div class="container py-14 py-md-5">
    <h2 class="display-4 mb-3 text-center">Why Hire Ionic Developers from RapidBrains</h2>
    ...
    <div class="row">
        ...
        <div id="accordion-1" class="accordion-wrapper">
          <div class="card accordion-item">
            ...
            <div id="accordion-collapse-1-1" class="accordion-collapse collapse show" aria-labelledby="accordion-heading-1-1" data-bs-target="#accordion-1">
              <div class="card-body">
                <p>Ionic is an open-source framework; using it is free, and it can lower
                    development costs.</p>
              </div>
              <!-- /.card-body -->
            </div>
          ...
          <div class="card accordion-item">
            <div class="card-header" id="accordion-heading-1-2">
              <button class="collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-collapse-1-2" aria-expanded="true" aria-controls="accordion-collapse-1-2">Cross Platform Development</button>
            </div>
            <!-- /.card-header -->
            <div id="accordion-collapse-1-2" class="accordion-collapse collapse show" aria-labelledby="accordion-heading-1-2" data-bs-target="#accordion-1">
              <div class="card-body">
                <p>Compared to creating separate apps for each platform, Ionic enables
                    developers to create apps that operate seamlessly on iOS and Android devices.
                    </p>                   </div>
              <!-- /.card-body -->
            </div>
            <!-- /.collapse -->
          ...
          <div class="card accordion-item">
            <div class="card-header" id="accordion-heading-1-3">
              <button class="collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-collapse-1-3" aria-expanded="true" aria-controls="accordion-collapse-1-3">User Experience</button>
            </div>
            <!-- /.card-header -->
      ...
      <div class="col-lg-6">
          <div id="accordion-2" class="accordion-wrapper">
              <div class="card accordion-item">
                ...
                <div id="accordion-collapse-2-2" class="accordion-collapse collapse show" aria-labelledby="accordion-heading-2-2" data-bs-target="#accordion-2">
                  <div class="card-body">
                    <p>Ionic apps are simple to scale up or down based on the demands of your
                        company.</p>
                    </div>
                  <!-- /.card-body -->
                </div>
        ...
        <div id="accordion-2" class="accordion-wrapper">
          <div class="card accordion-item">
            <div class="card-header" id="accordion-heading-2-2">
              <button class="collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-collapse-2-2" aria-expanded="true" aria-controls="accordion-collapse-2-2">Customizable</button>
            </div>
            <!-- /.card-header -->
            <div id="accordion-collapse-2-2" class="accordion-collapse collapse show" aria-labelledby="accordion-heading-2-2" data-bs-target="#accordion-2">
              <div class="card-body">
                <p>Ionic developers can easily customize the app's UI and design to meet your
                    needs, giving your users a unique and tailored experience.
                    </p>
                </div>
              <!-- /.card-body -->
            </div>
          ...
          <div class="card accordion-item">
            <div class="card-header" id="accordion-heading-2-3">
              <button class="collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-collapse-2-3" aria-expanded="true" aria-controls="accordion-collapse-2-3">Experience</button>
            </div>
            <!-- /.card-header -->
            <div id="accordion-collapse-2-3" class="accordion-collapse collapse show" aria-labelledby="accordion-heading-2-3" data-bs-target="#accordion-2">
              <div class="card-body">
                <p>Our developers have created a wide range of mobile apps and have experience
                    working with Ionic.</p>
                </div>
              <!-- /.card-body -->
            </div>
            <!-- /.collapse -->
