           ...
           <div class="row position-relative">
             <div class="col-lg-8 col-xxl-7 mx-auto position-relative">
               ...
               <div data-cues="slideInDown" data-group="page-title">
                 <h1 class="display-1 fs-62 mb-5 mx-md-10 mx-lg-0">Hire Dedicated Firebase Developers !</h1>
                 ...
                 <a href="https://talents.rapidbrains.com/filter?skill=firebase " class="btn btn-lg btn-primary btn-icon btn-icon-end">Hire Developers <i class="uil uil-arrow-up-right"></i></a>
...
<section class="wrapper bg-soft-red">
  <div class="container py-14 py-md-16">
    ...
    <div class="row">
      ...
      <a href="https://talents.rapidbrains.com/filter?skill=Firebase" class="btn btn-lg btn-primary btn-icon btn-icon-end">Hire Firebase Developers <i class="uil uil-arrow-up-right"></i></a>
      </div>
      <!-- /column -->
    </div>
    <!-- /.row -->
