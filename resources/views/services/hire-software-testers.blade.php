           ...
           <div class="row position-relative">
             <div class="col-lg-8 col-xxl-7 mx-auto position-relative">
               ...
               <div data-cues="slideInDown" data-group="page-title">
                 <h1 class="display-1 fs-62 mb-5 mx-md-10 mx-lg-0">Hire Remote Software Tester in 24 Hours!</h1>
                 ...
                 <a href="https://talents.rapidbrains.com/filter?skill=Software_Tester" class="btn btn-lg btn-primary btn-icon btn-icon-end mx-auto" style="color: #fff; max-width: 100%;">List all Software Testers with rates<i class="uil uil-arrow-up-right"></i></a>
  ...
  <div class="container py-14 py-md-16">
    <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
      <div class="col-lg-5 order-lg-2">
        <figure><img class="w-auto" style="width: 500px; height: 500px; max-width: 80%;" src="https://www.rapidbrains.com/assets/img/services/rapidbrains-softwaretesting.webp" srcset="https://www.rapidbrains.com/assets/img/services/rapidbrains-softwaretesting.webp" alt="rapidbrains-softwaretesting Logo" /></figure>
      </div>
      <!--/column -->
      <div class="col-lg-7">
