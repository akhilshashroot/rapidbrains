           ...
           <div class="row position-relative">
             <div class="col-lg-8 col-xxl-7 mx-auto position-relative">
               ...
               <div data-cues="slideInDown" data-group="page-title">
                 <h1 class="display-1 fs-62 mb-5 mx-md-10 mx-lg-0">Hire Magento Developers Remotely in 24 Hours!</h1>
  ...
  <div class="container py-14 py-md-16">
    <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
      <div class="col-lg-5 order-lg-2">
        <figure><img class="w-auto" style="width: 500px; heighr: 500px;" src="https://www.rapidbrains.com/assets/img/services/rapidbrains-magento.webp" srcset="https://www.rapidbrains.com/assets/img/services/rapidbrains-magento.webp" alt="Magento Logo" /></figure>
      </div>
      <!--/column -->
      <div class="col-lg-7">
