  ...
  <div class="container py-14 py-md-16">
    <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
      <div class="col-lg-5 order-lg-2">
        <figure><img class="w-auto" style="width: 500px; height: 500px; max-width: 100%;" src="https://www.rapidbrains.com/assets/img/services/english_assistant.webp" srcset="https://www.rapidbrains.com/assets/img/services/english_assistant.webp" alt="english_assistant Logo" /></figure>
      </div>
      <!--/column -->
      <div class="col-lg-7">
        <h2 class="fs-15 text-uppercase text-line text-primary mb-3">Our Benefits</h2>
        <h3 class="display-2 mb-7">Why Hire English Virtual Assistants from RapidBrains?</h3>
        <p>
          
        Hiring an English virtual assistant from RapidBrains ensures you receive expert, affordable, and remote services tailored to your business needs. Our VAs manage your administrative tasks, improve productivity, and provide professional support with excellent communication skills. Enjoy 24/7 support, quick hiring within 24 hours, and cost-effective solutions designed for success.
        ...
        <div class="card bg-soft-fuchsia mb-6">
          <div class="card-body d-flex flex-row">
            ...
            <div>
              ...
              Proficiency in handling emails, scheduling, data entry, and other administrative tasks.
        ...
        <div class="card bg-soft-aqua mb-6">
          <div class="card-body d-flex flex-row">
            ...
            <div>
              ...
              Excellent English communication skills for effective interaction with clients and team members.
        ...
        <div class="card bg-soft-leaf mb-6">
          <div class="card-body d-flex flex-row">
            ...
            <div>
              ...
              Skills in using office software like Microsoft Office, Google Workspace, and project management tools.
        ...
        <div class="card bg-soft-orange mb-6">
          <div class="card-body d-flex flex-row">
            ...
            <div>
              ...
              Strong organizational skills to maintain records, manage files, and ensure smooth operations.
        ...
        <div class="card bg-soft-grape">
          <div class="card-body d-flex flex-row">
            ...
            <div>
              ...
              Flexibility to adapt to various tasks and quickly learn new tools and processes.
             ...
             <div id="accordion-3" class="accordion-wrapper">
               <div class="card accordion-item">
                 <div class="card-header" id="accordion-heading-3-1">
                   ...
                   What tasks can an English virtual assistant handle?
                 ...
                 <div id="accordion-collapse-3-1" class="collapse" aria-labelledby="accordion-heading-3-1" data-bs-target="#accordion-3">
                   <div class="card-body">
                     ...
                     Our English virtual assistants are highly versatile and can manage a wide range of tasks including email management, scheduling, data entry, customer service, content creation, social media management, and more.
               ...
               <div class="card accordion-item">
                 ...
                 <div id="accordion-collapse-3-3" class="collapse" aria-labelledby="accordion-heading-3-3" data-bs-target="#accordion-3">
                   <div class="card-body">
                     ...
                     RapidBrains takes data security and confidentiality very seriously. Our virtual assistants are trained in best practices for data management and security, and we have stringent measures in place to protect your sensitive information.
