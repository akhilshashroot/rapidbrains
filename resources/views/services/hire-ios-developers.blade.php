    ...
    <div class="container py-14 py-md-16">
      <div class="row gy-10 gy-sm-13 gx-lg-3 align-items-center">
        ...
        <div class="col-lg-5 col-xl-4 offset-lg-1">
          <h2 class="h1 mb-3">Steps To Hire Android Developers</h2>
          <p class="lead fs-lg mb-6">A comprehensive guide to find and hire Android Developers for your organization.</p>
