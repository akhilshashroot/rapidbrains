           ...
           <div class="row position-relative">
             <div class="col-lg-8 col-xxl-7 mx-auto position-relative">
               ...
               <div data-cues="slideInDown" data-group="page-title">
                 ...
                 <a href="https://talents.rapidbrains.com/filter?skill=unreal_engine" class="btn btn-lg btn-primary btn-icon btn-icon-end">Hire Developers <i class="uil uil-arrow-up-right"></i></a>
  ...
  <div class="container py-14 py-md-16">
    <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
      <div class="col-lg-5 order-lg-2">
        <figure><img class="w-auto" style="width: 500px; heighr: 500px;" src="https://www.rapidbrains.com/assets/img/services/rapidbrains-ruby-on-rails.webp" srcset="https://www.rapidbrains.com/assets/img/services/rapidbrains-ruby-on-rails.webp" alt="Unreal engine Logo" /></figure>
      </div>
      <!--/column -->
      <div class="col-lg-7">
...
<section class="wrapper bg-soft-red">
  <div class="container py-14 py-md-16">
    ...
    <div class="row">
      ...
      <a href="https://talents.rapidbrains.com/filter?skill=unreal_engine" class="btn btn-lg btn-primary btn-icon btn-icon-end">Hire Unreal Engine Developers <i class="uil uil-arrow-up-right"></i></a>
      </div>
      <!-- /column -->
    </div>
    <!-- /.row -->
