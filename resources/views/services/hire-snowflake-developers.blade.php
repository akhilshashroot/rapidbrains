           ...
           <div class="row position-relative">
             <div class="col-lg-8 col-xxl-7 mx-auto position-relative">
               ...
               <div data-cues="slideInDown" data-group="page-title">
                 <h1 class="display-1 fs-62 mb-5 mx-md-10 mx-lg-0">Hire Remote Snowflake Developers in 24 Hours!</h1>
                 ...
                 <a href="https://talents.rapidbrains.com/filter?skill=Snowflake" class="btn btn-lg btn-primary btn-icon btn-icon-end mx-auto" style="color: #fff; max-width: 100%;">List all Snowflake developers with rates<i class="uil uil-arrow-up-right"></i></a>
