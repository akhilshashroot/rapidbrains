...
@section('section')
<section class="wrapper bg-soft-ash" style="background-image: url('https://www.rapidbrains.com/assets/img/rapidbrains-ceo/anees-ceo-1.webp'); margin-top: -70px;">
        <div class="container py-14 py-lg-16 pb-lg-0">
          <div class="row gx-lg-8 gx-xl-0 align-items-center">
            <!--<div class="col-lg-5 col-xl-4 offset-xl-1 d-none d-lg-flex position-relative">
              ...
              <figure><img src="https://www.rapidbrains.com/assets/img/rapidbrains-ceo/anees-ceo-1.webp" srcset="https://www.rapidbrains.com/assets/img/rapidbrains-ceo/anees-ceo-1.webp" alt=""></figure>
            </div>-->
            <!--/column -->
            <div class="col-lg-6 col-xl-6 col-xxl-7 offset-xl-1">
...
should make our customers smile :-)
                        ...
                        <div class="blockquote-details">
                          <div class="info ps-0">
                            <h6 class="mb-1">Anees T</h6>
                            <p class="mb-0 fs-13">Founder & CEO</p>
                          </div>
                        </div>
                      </blockquote>
                    </div>
