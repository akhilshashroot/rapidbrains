          ...
          <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
            ...
            <ul class="navbar-nav">
                  <li class="nav-item dropdown dropdown-mega">
                    <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" style='color: #343f52;'>Hire Developers</a>
                    <ul class="dropdown-menu mega-menu">
                      <li class="mega-menu-content">
                        <div class="container">
                          <div class="row">
                            <div class="col-lg-2">
                              <h6 class="dropdown-header" style="padding-left: 25px; font-size: 0.65rem; white-space: nowrap;">Front End Development</h6>
                              ...
                              <h6 class="dropdown-header mt-4" style="padding-left: 25px; font-size: 0.65rem; white-space: nowrap;">Data and AI</h6>
                              <ul class="list-unstyled">
                            ...
                            <div class="col-lg-2">
                              <h6 class="dropdown-header" style="padding-left: 25px; font-size: 0.65rem; white-space: nowrap;">Back End Development</h6>
                              <ul class="list-unstyled">
                               <li><a class="dropdown-item" href="{{route('hire-back-end-developers')}}">Back End Developers</a></li>
                                ...
                                <li><a class="dropdown-item" href="{{route('hire-ruby-on-rails-developers')}}">Ruby on Rails </a></li>
                            ...
                            <div class="col-lg-2">
                              <h6 class="dropdown-header" style="padding-left: 25px; font-size: 0.65rem; white-space: nowrap;">Full Stack Development</h6>
                              <ul class="list-unstyled">
                              ...
                              <h6 class="dropdown-header mt-4" style="padding-left: 25px; font-size: 0.65rem; white-space: nowrap;">Database Development</h6>
                              <ul class="list-unstyled">
                              ...
                              <h6 class="dropdown-header mt-4" style="padding-left: 25px; font-size: 0.65rem; white-space: nowrap;">Game Development</h6>
                              <ul class="list-unstyled">
                                <li><a class="dropdown-item" href="{{route('hire-unity-developers')}}">Unity Developers</a></li>
                                <li><a class="dropdown-item" href="{{route('hire-unreal-engine-developers')}}">Unreal Engine </a></li>
                              </ul>
                            </div>
                            <div class="col-lg-2">
                              <h6 class="dropdown-header" style="padding-left: 25px; font-size: 0.65rem; white-space: nowrap;">Mobile Development</h6>
                              <ul class="list-unstyled">
                              ...
                              <h6 class="dropdown-header mt-4" style="padding-left: 25px; font-size: 0.65rem; white-space: nowrap;">QA and Testing</h6>
                              <ul class="list-unstyled">
                            ...
                            <div class="col-lg-2">
                              <h6 class="dropdown-header" style="padding-left: 25px; font-size: 0.65rem; white-space: nowrap;">CMS Development</h6>
                              <ul class="list-unstyled">
                              ...
                              <h6 class="dropdown-header mt-4" style="padding-left: 25px; font-size: 0.65rem; white-space: nowrap;">Specialized Roles</h6>
                              <ul class="list-unstyled">
                                ...
                                <li><a class="dropdown-item" href="{{route('hire-quantum-computing-developers')}}">Quantum Computing </a></li>
                                ...
                                <li><a class="dropdown-item" href="{{route('hire-automation-testers')}}">Automation Testers</a></li><li><a class="dropdown-item" href="{{route('hire-remote-informatica-developers')}}">Informatica Developers</a></li>
                            ...
                            <div class="col-lg-2">
                              <h6 class="dropdown-header" style="padding-left: 25px; font-size: 0.65rem; white-space: nowrap;">DevOps and Cloud</h6>
                              <ul class="list-unstyled">
                                ...
                                <li><a class="dropdown-item" href="{{route('hire-kubernetes-developers')}}">Kubernetes </a></li>
                  ...
                  <li class="nav-item dropdown dropdown-mega">
                    <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" style='color: #343f52;'>Hire Assistants</a>
                    <ul class="dropdown-menu mega-menu">
                      <li class="mega-menu-content">
                        <div class="container">
                          <div class="row">
                            <div class="col-lg-3">
                              <h6 class="dropdown-header" style="padding-left: 25px; font-size: 0.65rem; white-space: nowrap;">Administration</h6>
                              <ul class="list-unstyled">
                            ...
                            <div class="col-lg-3">
                              <h6 class="dropdown-header" style="padding-left: 25px; font-size: 0.65rem; white-space: nowrap;">Customer Support</h6>
                              <ul class="list-unstyled">
                            ...
                            <div class="col-lg-3">
                              <h6 class="dropdown-header" style="padding-left: 25px; font-size: 0.65rem; white-space: nowrap;">Marketing</h6>
                              <ul class="list-unstyled">
                            ...
                            <h6 class="dropdown-header" style="padding-left: 25px; font-size: 0.65rem; white-space: nowrap;">Multilingual</h6>
                              <ul class="list-unstyled">
