                  ...
                  <ul class="dropdown-menu mega-menu">
                    <li class="mega-menu-content" style="margin-right: 30px;">
                      <ul class="row row-cols-1 row-cols-lg-6 gx-0 gx-lg-6 gy-lg-1 list-unstyled">
                            ...
                            <li><a class="dropdown-item" title="Software Testers" href="{{route('hire-software-testers')}}">Software Testers</a></li>
                            <li><a class="dropdown-item" title="VAPT Testers" href="{{route('hire-vapt-testers')}}">VAPT Testers</a></li>
                            ...
                            <li><a class="dropdown-item" tite="Prometheus Developer" href="{{route('hire-prometheus-developers')}}">Prometheus Developers</a></li>
                            ...
                            <li><a class="dropdown-item" tite="Data Engineers" href="{{route('hire-data-engineers')}}">Data Engineers</a></li>
