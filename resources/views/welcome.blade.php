...
<section class="wrapper bg-gray">
  ...
  <!-- /.container -->
  <figure class="position-absoute" style="bottom: 0; left: 0; z-index: 2;"><img src="./assets/img/photos/Web Banner-min.jpg
  ...
  <div class="container py-14 py-md-16">
    ...
    <div class="row gx-md-8 gy-8">
      <div class="col-md-6 col-lg-3">
        ...
        <a href="https://rapidbrains.com/benefits.html" class="more hover link-yellow">Learn More</a>
      </div>
      <!--/column -->
      <div class="col-md-6 col-lg-3">
        ...
        <a href="https://rapidbrains.com/benefits.html" class="more hover link-red">Learn More</a>
      </div>
      <!--/column -->
      <div class="col-md-6 col-lg-3">
        ...
        <a href="https://rapidbrains.com/benefits.html" class="more hover link-leaf">Learn More</a>
      </div>
      <!--/column -->
      <div class="col-md-6 col-lg-3">
        ...
        <a href="https://rapidbrains.com/benefits.html" class="more hover link-blue">Learn More</a>
      </div>
      <!--/column -->
    </div>
    <!--/.row -->
        ...
        <div class="card shadow-lg position-absolute d-none d-md-block" style="top: 15%; left: -7%">
          <div class="card-body py-4 px-5">
            <div class="d-flex flex-row align-items-center">
              <div>
                <img src="{{asset('assets/img/icons/solid/alarm.svg')}}" class="svg-inject icon-svg icon-svg-xs solid-mono text-primary me-3" alt="" />
              </div>
              <div>
    ...
    <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
      ...
      <div class="col-lg-5">
        ...
        <p>With RapidBrains you can hire employee without having to set up a local entity. We do hiring, onboarding, HR activities and comply with the local labour law for minimum wage, tax, health insurance, termination and so on.</p>
            <a href="https://rapidbrains.com/process.html" class="btn btn-navy rounded-pill mt-3">More Details</a>
      </div>
      <!--/column -->
      <div class="col-lg-7 order-lg-2">
          ...
          <div class="col-md-5 offset-md-1 align-self-end">
            <div class="card bg-pale-yellow">
              <div class="card-body">
                <img src="{{asset('assets/img/icons/lineal/telephone-3.svg')}}" class="svg-inject icon-svg icon-svg-md text-yellow mb-3" alt="" />
          ...
          <div class="col-md-6 align-self-end">
            <div class="card bg-pale-red">
              <div class="card-body">
                <img src="{{asset('assets/img/icons/lineal/shield.svg')}}" class="svg-inject icon-svg icon-svg-md text-red mb-3" alt="" />
          ...
          <div class="col-md-5">
            <div class="card bg-pale-leaf">
              <div class="card-body">
                <img src="{{asset('assets/img/icons/lineal/cloud-computing-3.svg')}}" class="svg-inject icon-svg icon-svg-md text-leaf mb-3" alt="" />
          ...
          <div class="col-md-6 align-self-start">
            <div class="card bg-pale-primary">
              <div class="card-body">
                <img src="{{asset('assets/img/icons/lineal/analytics.svg')}}" class="svg-inject icon-svg icon-svg-md text-primary mb-3" alt="" />
...
<!-- /section -->
  ...
  <div class="container py-20 py-md-20" style= "adding-top: 10rem !important;
    padding-bottom: 1rem !important;">
     ...
     <div class="card image-wrapper shadow-lg mt-n21 mt-md-n23 bg-full bg-image mb-14" data-image-src="./assets/img/photos/RapidBrains-Footerbg.jpg">
        <div class="card-body">
          <div class="row text-center">
