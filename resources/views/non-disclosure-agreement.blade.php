...
<section class="wrapper bg-gray">
      <div class="container pt-10 pb-12 pt-md-14 pb-md-16 text-center">
        <div class="row">
          <div class="col-md-10 col-lg-8 col-xl-7 col-xxl-6 mx-auto">
            <h1 class="display-1 mb-3">Non-Disclosure Agreement</h1>
 ...
 <div class="container">
      <div class="row gx-0">
          ...
          <div class="widget">
            <nav id="sidebar-nav">
              <ul class="list-unstyled text-reset">
                <li><a class="nav-link scroll active" href="#definition-of-confidential-information">1. Definition of Confidential Information</a></li>
                <li><a class="nav-link scroll" href="#disclosure-of-confidential-information">2. Disclosure Of Confidential Information</a></li>
                <li><a class="nav-link scroll" href="#use-of-confidential-information">3. Use of Confidential Information</a></li>
                <li><a class="nav-link scroll" href="#compelled-disclosure-of-confidential-information">4. Compelled Disclosure of Confidential Information</a></li>
                <li><a class="nav-link scroll" href="#term">5. Term</a></li>
                <li><a class="nav-link scroll" href="#remedies">6. Remedies</a></li>
                <li><a class="nav-link scroll" href="#return-of-confidential-information">7. Return of Confidential Information</a></li>
                 <li><a class="nav-link scroll" href="#notice-of-breach">8. Notice of Breach </a></li>
                  <li><a class="nav-link scroll" href="#no-binding-agreement-for-transaction">9. No Binding Agreement For Transaction</a></li>
                <li><a class="nav-link scroll" href="#changes-to-this-privacy-policy">10. Changes to this Privacy Policy</a></li>

                  <li><a class="nav-link scroll" href="#miscellaneous">11. Miscellaneous </a></li>
        ...
        <!-- /column -->
        <div class="col-xl-8">
          <section id="definition-of-confidential-information" class="wrapper pt-16">
            <div class="card">
              <div class="card-body p-10">
                <h2 class="mb-3">1. Definition of Confidential Information</h2>
                <p>For purposes of this Agreement, “Confidential Information” means any data or information that is proprietary to the Disclosing Party and not generally known to the public, whether in tangible or intangible form, whenever and however disclosed, including, but not limited to:</P>
                <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                  <li><span><i class="uil uil-check"></i></span><span>   Any marketing strategies, plans, financial information, or projections, operations, sales estimates, business plans and performance results relating to the past, present or future business activities of such party, its affiliates, subsidiaries and affiliated companies</span></li>
                  <li><span><i class="uil uil-check"></i></span><span> Plans for products or services, and customer or supplier lists; </span></li>
                  <li><span><i class="uil uil-check"></i></span><span>Any scientific or technical information, invention, design, process, procedure, formula, improvement, technology or method;
 </span></li>
                  <li><span><i class="uil uil-check"></i></span><span> Any concepts, reports, data, know-how, works-in-progress, designs, development tools, specifications, computer software, source code, object code, flow charts, databases, inventions, information and trade secrets; and
 </span></li>
                  <li><span><i class="uil uil-check"></i></span><span> Any other information that should reasonably be recognized as confidential information of the Disclosing Party. Confidential Information need not be novel, unique, patentable, copyrightable or constitute a trade secret in order to be designated Confidential Information. The Receiving Party acknowledges that the Confidential Information is proprietary to the Disclosing Party, has been developed and obtained through great efforts by the Disclosing Party and that Disclosing Party regards all of its Confidential Information as trade secrets
</span></li>
</ul>

                  <p></p>
                  <p>Notwithstanding anything in the foregoing to the contrary, Confidential Information shall not include information which:</p>
                  
                  <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                  <li><span><i class="uil uil-check"></i></span><span> Was known by the Receiving Party prior to receiving the Confidential Information from the Disclosing Party;
  </span></li>
                  <li><span><i class="uil uil-check"></i></span><span> Becomes rightfully known to the Receiving Party from a third-party source not known (after diligent inquiry) by the Receiving Party to be under an obligation to Disclosing Party to maintain confidentiality;
  </span></li>
                  <li><span><i class="uil uil-check"></i></span><span> Is or becomes publicly available through no fault of or failure to act by the Receiving Party in breach of this Agreement;
  </span></li>
                  <li><span><i class="uil uil-check"></i></span><span> Is required to be disclosed in a judicial or administrative proceeding, or is otherwise requested or required to be disclosed by law or regulation, although the requirements of paragraph 4 hereof shall apply prior to any disclosure being made; and
  </span></li>
                  <li><span><i class="uil uil-check"></i></span><span> Is or has been independently developed by employees, consultants or agents of the Receiving Party without violation of the terms of this Agreement or reference or access to any Confidential Information.
  </span></li>
          ...
          <section id="disclosure-of-confidential-information" class="wrapper pt-16">
            <div class="card">
              <div class="card-body p-10">
                <h2 class="mb-3">2. Disclosure OF Confidential Information</h2>
          ...
          <section id="use-of-confidential-information" class="wrapper pt-16">
            <div class="card">
              <div class="card-body p-10">
                <h2 class="mb-3">3. Use of Confidential Information</h2>
          ...
          <section id="remedies" class="wrapper pt-16">
            <div class="card">
              <div class="card-body p-10">
                <h2 class="mb-3">6. Remedies</h2>
          ...
          <section id="return-of-confidential-information" class="wrapper pt-16">
            <div class="card">
              <div class="card-body p-10">
                <h2 class="mb-3">7. Return of Confidential Information </h2>
          ...
          <section id="notice-of-breach" class="wrapper pt-16">
            <div class="card">
              <div class="card-body p-10">
                <h2 class="mb-3">8. Notice of Breach  </h2>
          ...
          <section id="no-binding-agreement-for-transaction" class="wrapper pt-16">
            <div class="card">
              <div class="card-body p-10">
                <h2 class="mb-3">9. No Binding Agreement For Transaction  </h2>
          ...
          <section id="miscellaneous" class="wrapper pt-16">
            <div class="card">
              <div class="card-body p-10">
                <h2 class="mb-3">11.  Miscellaneous  </h2>
                <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                  <li><span><i class="uil uil-check"></i></span><span> This Agreement constitutes the entire understanding between the parties and supersedes any and all prior or contemporaneous understandings and agreements, whether oral or written, between the parties, with respect to the subject matter hereof. This Agreement can only be modified by a written amendment signed by the party against whom enforcement of such modification is sought.
  </span></li>
                  <li><span><i class="uil uil-check"></i></span><span> The validity, construction and performance of this Agreement shall be governed and construed in accordance with the laws of India applicable to contracts made and to be wholly performed within such state, without giving effect to any conflict of laws provisions thereof. The Federal and state courts located in India shall have sole and exclusive jurisdiction over any disputes arising under the terms of this Agreement.
  </span></li>
                  <li><span><i class="uil uil-check"></i></span><span> Any failure by either party to enforce the other party’s strict performance of any provision of this Agreement will not constitute a waiver of its right to subsequently enforce such provision or any other provision of this Agreement.
  </span></li>
                  <li><span><i class="uil uil-check"></i></span><span> Although the restrictions contained in this Agreement are considered by the parties to be reasonable for the purpose of protecting the Confidential Information, if any such restriction is found by a court of competent jurisdiction to be unenforceable, such provision will be modified, rewritten or interpreted to include as much of its nature and scope as will render it enforceable. If it cannot be so modified, rewritten or interpreted to be enforceable in any respect, it will not be given effect, and the remainder of the Agreement will be enforced as if such provision was not included.
  </span></li>
                  <li><span><i class="uil uil-check"></i></span><span> Any notices or communications required or permitted to be given hereunder may be delivered by hand, deposited with a nationally recognized overnight carrier, electronic-mail, or mailed by certified mail, return receipt requested, postage prepaid, in each case, to the address of the other party first indicated above (or such other addressee as may be furnished by a party in accordance with this paragraph). All such notices or communications shall be deemed to have been given and received (a) in the case of personal delivery or electronic-mail, on the date of such delivery, (b) in the case of delivery by a nationally recognized overnight carrier, on the third business day following dispatch and (c) in the case of mailing, on the seventh business day following such mailing.
  </span></li>
                  <li><span><i class="uil uil-check"></i></span><span> This Agreement is personal in nature, and neither party may directly or indirectly assign or transfer it by operation of law or otherwise without the prior written consent of the other party, which consent will not be unreasonably withheld. All obligations contained in this Agreement shall extend to and be binding upon the parties to this Agreement and their respective successors, assigns and designees.
  </span></li>
                  <li><span><i class="uil uil-check"></i></span><span> The receipt of Confidential Information pursuant to this Agreement will not prevent or in any way limit either party from: (i) developing, making or marketing products or services that are or may be competitive with the products or services of the other; or (ii) providing products or services to others who compete with the other.
  </span></li>
                  <li><span><i class="uil uil-check"></i></span><span> Paragraph headings used in this Agreement are for reference only and shall not be used or relied upon in the interpretation of this Agreement.
  </span></li>
